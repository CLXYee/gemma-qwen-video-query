...
```// filepath: /home/nvidia/Downloads/gemma-qwen-video-query/gemma-qwen-video-query/USAGE.md
# USAGE — Gemma-Qwen Video Query
...
If a specific example or a short script for your environment is needed, provide the target (camera, file, or Jetson) and desired